...
public class HesapMakinasiGelismis {
    static void plus() {
    ...
    static void mod(){
        ...
        a=tara.nextInt();
        x=n%a;
        System.out.println(n + " sayısının "+a+" sayısına göre Modu = "+x);
    }
    static void dikdortgenAlanVeCevreHesabi(){
        int a=0,b=0,alan,cevre;
        ...
        else System.out.println("Hatalı giriş yaptınız! Pozitif sayı giriniz.");
    }
